...
```mermaid
graph TD
    Scenario["Khách gạt đi: 'Anh bận lắm, không chơi chứng khoán đâu, toàn lừa đảo!''"] --> ChoiceA["Option A: Cố nài nỉ giải thích thêm về lợi nhuận chứng khoán"]
    Scenario --> ChoiceB["Option B: Thấu cảm, đồng ý với khách, xin phép kết bạn Zalo gửi tài liệu phi thương mại rồi cúp máy lịch sự"]
    Scenario --> ChoiceC["Option C: Tự ái cúp máy ngay không chào"]

    ChoiceA --> ResA["🔴 THẤT BẠI (0 XP)<br>Khách cúp máy cộc lốc và cho số điện thoại của bạn vào danh sách chặn."]
    ChoiceB --> ResB["🟢 XUẤT SẮC (+100 XP ✨)<br>Hạ nhiệt căng thẳng, mở đường kết nối Zalo để chuyển đổi thành Warm Lead sau này."]
    ChoiceC --> ResC["🔴 THẤT BẠI (0 XP)<br>Mất cơ hội kết nối."]
```
