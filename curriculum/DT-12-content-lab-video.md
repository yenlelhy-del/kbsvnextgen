...
```mermaid
graph TD
    Scenario["Video phân tích Fed dài 3 phút mở đầu 20 giây định nghĩa bị flop 80 view"] --> ChoiceA["Option A: Đổ lỗi cho thuật toán TikTok bóp tương tác, tiếp tục đăng các video tương tự"]
    Scenario --> ChoiceB["Option B: Cắt gọt kịch bản dưới 60 giây, thay thế 20s định nghĩa bằng Hook 3s giật tít 'Lãi suất tăng - Ví tiền của bạn bốc hơi thế nào?'"]
    Scenario --> ChoiceC["Option C: Thuê dịch vụ chạy quảng cáo view ảo để tăng uy tín"]

    ChoiceA --> ResA["🔴 THẤT BẠI (0 XP)<br>Kênh bị gắn nhãn spam nội dung nhàm chán, không thể tiếp cận người dùng mới."]
    ChoiceB --> ResB["🟢 XUẤT SẮC (+100 XP ✨)<br>Làm chủ tư duy phân phối video ngắn, tối ưu hóa tỷ lệ giữ chân người xem đột phá."]
    ChoiceC --> ResC["🔴 VI PHẠM CHÍNH SÁCH (0 XP)<br>Kênh bị khóa vì gian lận tương tác."]
```
