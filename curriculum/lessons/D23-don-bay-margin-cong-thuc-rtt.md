...
*   **Thời lượng học:** Cả ngày (bám sát Daily Routine: Morning Briefing → Content Lab → CRM Update → Margin Math Session).
...
| :--- | :--- | :--- |
| **$\text{RTT} ≥ 45%** | **Vùng An Toàn (Safe Zone)** | Tài khoản hoạt động bình thường. Khách hàng có thể tiếp tục đặt lệnh mua thêm cổ phiếu mới hoặc rút tiền nhặng dư ra ngoài. |
| **$35% ≤ \text{RTT} < 45%** | **Vùng Cảnh Báo (Warning Zone)** | Hệ thống gửi cảnh báo màu vàng trên app. Tài khoản không được phép mua thêm cổ phiếu bằng Margin. Broker cần chủ động theo dõi sát. |
| **$30% ≤ \text{RTT} < 35%** | **Vùng Call Margin (Call Zone)** | **Hệ thống tự động gửi tin nhắn Call Margin.** Khách hàng có nghĩa vụ phải nộp thêm tiền mặt hoặc chủ động bán bớt cổ phiếu để đưa RTT phục hồi về mức an toàn tối thiểu **40%** trong vòng 2 phiên giao dịch. |
...
### 🎭 Tình huống: Giải thích cơ chế Margin cho khách hàng F0 muốn vay 100% tiền để mua cổ phiếu — Cảnh báo rủi ro đòn bẩy
*   **Nhân vật:**
    *   **Broker NextGen HO3 (Học viên):** Am hiểu cơ chế Margin, RTT, biết cách cảnh báo rủi ro bằng số liệu cụ thể.
    *   **Anh Phong (Khách hàng F0):** 28 tuổi, nhân viên IT, vừa mở tài khoản KBSV. Có 100 triệu tiền nhàn rỗi, muốn vay thêm 100 triệu Margin để "đánh lớn" mã HPG vì thấy "nó đang rẻ".

#### 📞 Đoạn Đối Thoại Mẫu (Script)

*   **Anh Phong (giọng hào hứng, tự tin):** *Em ơi, anh thấy HPG đang rẻ lắm, giá 25.000 đồng. Anh muốn dùng hết 100 triệu anh có rồi vay thêm 100 triệu Margin nữa để mua 200 triệu HPG luôn. Lên 20% là anh lãi 40 triệu, ngon!*
*   **Broker NextGen (giọng bình tĩnh, chuyên nghiệp):** *Dạ anh Phong, HPG là cổ phiếu cơ bản tốt. Nhưng trước khi anh quyết định dùng đòn bẩy, cho em giải thích nhanh cơ chế Margin để anh hiểu rõ rủi ro nhé. Anh có 100 triệu tiền mình, vay thêm 100 triệu — tỷ lệ đòn bẩy 1:1. Nếu HPG tăng 20%, anh lãi 40 triệu đúng rồi. NHƯNG nếu HPG giảm 20% thôi, anh lỗ cũng 40 triệu — mất 40% vốn tự có. Và tỷ lệ RTT lúc đó sẽ rơi về khoảng 30%, hệ thống sẽ Call Margin anh nộp thêm tiền hoặc bán cổ phiếu.*
*   **Anh Phong (hơi chùn):** *Thế nếu anh không có tiền nộp thêm thì sao em?*
*   **Broker NextGen (nghiêm túc):** *Nếu anh không nộp đủ trong thời hạn, hệ thống sẽ tự động bán giải chấp cổ phiếu của anh — gọi là Force Sell — ở mức giá ATO sáng hôm sau, có thể là giá sàn. Lúc đó anh bị bán thụ động ở giá xấu nhất. Em đề xuất thế này: anh F0 mới, nên bắt đầu bằng 100% tiền mình trước, chưa vay Margin. Khi anh đã thực hành tích sản được 3-6 tháng, hiểu rõ biên độ dao động của HPG, lúc đó mình mới bàn đến Margin ở mức an toàn tỷ lệ 1:0.3 thôi ạ.*
*   **Anh Phong (suy nghĩ):** *Hmm, vậy anh cứ mua 100 triệu tiền mình trước rồi từ từ nhé?*
*   **Broker NextGen (khuyến khích):** *Dạ đúng rồi anh! Nguyên tắc vàng là: Margin không phải công cụ để giàu nhanh, mà là công cụ khuếch đại — khuếch đại cả lãi lẫn lỗ. Anh dùng 100 triệu tiền mình mua HPG, tích sản đều đặn mỗi tháng, ngủ ngon, không lo Force Sell. Anh thấy thế nào ạ?*
*   **Anh Phong (đồng ý):** *Oke em, nghe em phân tích anh hết muốn vay rồi! Cứ 100 triệu tiền mình đi, an toàn hơn.*
...
| :--- | :---: | :--- | :---: |
| **Giải thích cơ chế Margin/RTT (Technical)** | **40%** | Giải thích đúng khái niệm đòn bẩy, RTT, Call Margin, Force Sell bằng ví dụ số cụ thể. | / 40 |
| **Cảnh báo rủi ro đúng mực (Risk Warning)** | **35%** | Không hù dọa nhưng trình bày rủi ro rõ ràng; dùng kịch bản "nếu giảm 20%" để khách hàng tự nhận ra. | / 35 |
| **Đề xuất phương án an toàn** | **25%** | Khuyên F0 bắt đầu 100% tiền mình; hẹn review Margin sau 3-6 tháng kinh nghiệm. | / 25 |
